...
3. 8-digit padded serial Ã¢â€ â€™ invoice `tax_serial`.
...
|---------|---------|----------|
| Invoice-level payment | Ã¢Å“â€¦ | Ã¢ÂÅ’ |
| Batch payment receipt | Ã¢Å“â€¦ schema (`payment_allocations`) | Ã¢ÂÅ’ |
| Bank transfer transaction | Ã¢ÂÅ’ | UI shell |
| PDC/Giro | Ã¢Å“â€¦ schema | UI shell / Coming Soon |
| Faktur serial | Ã¢Å“â€¦ schema | Ã¢ÂÅ’ |
| Closing AR | Ã¢Å“â€¦ schema | Coming Soon |
| Recalculate balance | Ã¢ÂÅ’ | Coming Soon |
