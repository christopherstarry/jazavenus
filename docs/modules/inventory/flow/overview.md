# Inventory Flow Ã¢â‚¬â€ End to End
...
```
available = on_hand Ã¢Ë†â€™ committed
```
...
|---------|---------|----------|
| Stock on-hand query | Ã¢Å“â€¦ | Dashboard partial |
| Manual adjustment | Ã¢Å“â€¦ Admin | Ã¢ÂÅ’ |
| BPB document | Ã¢Å“â€¦ schema | UI shell |
| BBK document | Ã¢Å“â€¦ schema | UI shell |
| Transfer | Ã¢Å“â€¦ schema | UI shell |
| Stock taking | Ã¢Å“â€¦ schema | UI shell |
| Planning | Ã¢ÂÅ’ | UI shell |
