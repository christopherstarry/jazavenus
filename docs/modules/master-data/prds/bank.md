...
## 6. API â€” CRUD at `/api/banks`

## 7. History / Audit
Every create, update, and delete on bank records is logged to `audit_logs`. Developer and SuperAdmin can view the change history at `/system/audit-history`. See `docs/modules/master-data/prds/audit-history.md` for the full spec.
