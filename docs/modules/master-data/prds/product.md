...
interface Product {
  ...
  manufacturer_id: string;         // FK â†’ manufacturers (MnfctrCode)
  brand_id: string;                // FK â†’ brands (BrandCode)
  category_id: string;             // FK â†’ product_categories (CatgryCode)
  sub_category_id: string;         // FK â†’ product_sub_categories (SubCatCode)
...
interface ProductSubCategory {
  ...
  name: string;
  category_id: string;       // FK â†’ product_categories
}
...
|--------|-----------|------------|----------------|-----------|
| View products | âœ… | âœ… | âœ… | âŒ |
| Create/Edit product | âœ… | âœ… | âœ… | âŒ |
| Delete product | âœ… | âœ… | âŒ | âŒ |
| View prices | âœ… | âœ… | âœ… | âŒ |
| Edit prices (Dev/SuperAdmin) | âœ… | âœ… | âŒ (view only) | âŒ |
| Manage lookups (brands, categories, etc.) | âœ… | âœ… | âœ… (no delete) | âŒ |
...
- Click row â†’ detail with: basic info, pricing, inventory (read-only)
- Inline price: current prices shown as read-only badges (HJP/HPD/HET/HPP)
- "New Product" button
- Delete hidden for Admin-level

### Price Tab
- For Dev/SuperAdmin: editable grid â€” Product, Tier, Price, Start Date, End Date, Current
