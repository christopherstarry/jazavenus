...
## 7. History / Audit
Every create, update, and delete on supplier records is logged to `audit_logs`. Developer and SuperAdmin can view the full change history at `/system/audit-history` or click the "Audit History" button on any supplier detail page. See `docs/modules/master-data/prds/audit-history.md` for the full spec.
