...
## 5. Permissions
Master access: view only (cannot edit tax registration â€” sensitive financial data). Dev/SuperAdmin: full.
...
## 7. History / Audit
Every create, update, and delete on tax registrations is logged to `audit_logs`. Developer and SuperAdmin can view the change history at `/system/audit-history`. See `docs/modules/master-data/prds/audit-history.md` for the full spec.
