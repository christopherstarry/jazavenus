...
## 4. Database Table
`cost_types` (from legacy `CodeDescription` or new â€” minimal data, ~5 rows)
...
## 7. History / Audit
Every create, update, and delete on cost types is logged to `audit_logs`. Developer and SuperAdmin can view the full change history at `/system/audit-history`. See `docs/modules/master-data/prds/audit-history.md` for the full spec.
