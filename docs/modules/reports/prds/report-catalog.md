...
**Purpose:** Master index of all legacy reports vs new app status. Per-report UI specs live in domain catalogs below.

| Document | Reports |
|----------|---------|
| [report-screen-pattern.md](report-screen-pattern.md) | Shared report UI template (filters, F5, export) |
| [sales-reports.md](sales-reports.md) | 45 sales reports |
| [inventory-reports.md](inventory-reports.md) | 25 inventory reports |
| [purchase-reports.md](purchase-reports.md) | 6 purchase reports |
| [ar-reports.md](ar-reports.md) | 23 A/R reports |

**Backend catalog:** 94 keys in `Jaza.Infrastructure.Reports.ReportCatalog` (+ built-in shortcuts). Source: `frontend/src/app/modules.tsx` report tree + legacy `13-prd-reports.md`.
