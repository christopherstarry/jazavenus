# PRD for Non-Technical Users â€” Write Expectations, Let AI Figure Out the Rest
...
- **List page** â€” shows all records in a table
- **New form** â€” create a new record
- **Edit form** â€” change an existing record

## 3. What data does the user see?
[List every field the user should see. Don't worry about types or formats â€” just describe it.]
...
1. **Open the page** â€” does it exist at the URL the AI tells you?
2. **Look at the data** â€” are all fields from Section 3 visible?
3. **Test every action** â€” can you do everything in Section 4?
4. **Try to break it** â€” type nothing and submit, type huge numbers, search for nonsense
5. **Test the rules** â€” try to do things Section 5 says you can't do
6. **Check loading** â€” does it show a spinner while loading?
7. **Check empty** â€” what happens when there's no data?
8. **Check error** â€” turn off the server, does it show an error or crash?
