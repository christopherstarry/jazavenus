...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-start justify-between gap-3 overflow-hidden rounded-[var(--radius)] border-2 p-4 pr-8 shadow-lg transition-all",
  {
    variants: {
      variant: {
