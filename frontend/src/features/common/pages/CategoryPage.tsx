...
export function CategoryPage() {
  ...
  return <ReferenceDataPage title="Categories" apiPath="master/categories" columns={columns} fields={fields} transformDto={(dto) => ({ ...dto, code: genCode() })} canDelete={canDelete} />;
}