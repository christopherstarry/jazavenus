...
export function UnitOfMeasurePage() {
  ...
  return <ReferenceDataPage title="Units of Measure" apiPath="master/units" columns={columns} fields={fields} transformDto={(dto) => ({ ...dto, code: genCode() })} canDelete={canDelete} />;
}