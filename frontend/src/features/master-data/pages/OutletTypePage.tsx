...
export function OutletTypePage() {
  ...
  return <ReferenceDataPage title="Outlet Types" apiPath="master/outlet-types" columns={columns} fields={fields} transformDto={(dto) => ({ ...dto, code: genCode() })} canDelete={canDelete} />;
}